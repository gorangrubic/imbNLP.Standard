...
{
    //    public class PageRankDouble
    //    {

    //        #region Private Fields

    //        private ArrayList _incomingLinks, _leafNodes;
    //        private Vector<double> _numLinks;
    //        private double _alpha, _convergence;
    //        private int _checkSteps;
    ...
    //        /// </summary>
    //        /// <param name="linkMatrix">Link sparse matrix</param>
    //        /// <param name="alpha">The alpha / damping</param>
    //        /// <param name="convergence">The convergence.</param>
    //        /// <param name="checkSteps">The check steps.</param>
    ...
    //            {
    //                incomingLinks.Add(new List<Double>());
    //            }
    ...
    //            for (int i = 0; i < nPages; i++)
    //            {
    //                List<Double> values = outGoingLinks[i] as List<Double>;
    //                if (values.Count == 0)
    //                    leafNodes.Add(i);
    //                else
    //                {
    ...
    //                    {
    //                        List<Double> list = (List<Double>)incomingLinks[Convert.ToInt32(j)];
    //                        list.Add(i);
