/*
 * Adapted from: https://github.com/antiufo/Shaman.Stemming
 * Author of original code: Andrea Martinelli, http://shaman.io/
 * Original licence:
 * 
...
namespace imbNLP.Toolkit.Stemmers.Shaman
{
    ...
    public abstract class SnowballProgram : IStemmer
    {
        ...
        public virtual void SetCurrent(String value)
        {
            ...
            current.Append(value); // .AppendValueString(value);
            cursor = 0;
